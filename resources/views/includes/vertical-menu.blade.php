    ...
    <div data-simplebar class="h-100">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                <li class="menu-title">Login As: {{ Auth::user()->name }}</li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="email-inbox.html">Designation</a></li>
                        <li><a href="email-read.html">Level</a></li>
                        <li><a href="email-compose.html">Employment Ststus</a></li>
                    </ul>
                </li>
